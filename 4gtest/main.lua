...
sys.taskInit(
    function()
        ...
        --log.info("uart.PAR_EVEN", uart.PAR_EVEN, type(uart.PAR_EVEN), uart.STOP_1, type(uart.STOP_1))
        testUart.UartConfig("{\"cmd\":\"config\",\"id\":\"9\", \"baudrate\":\"2400\", \"datbits\":\"8\",\"parity\":\"0\", \"stopbits\":\"0\"}")
        --uart.setup(2, 2400, 8, uart.PAR_EVEN, uart.STOP_1)
        --开启远程控制
